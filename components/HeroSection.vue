              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    ...
                    <div class="mt-3">
                      <h4>Muhammad Hillal Alhamdi</h4>
                      <p class="text-secondary mb-1">Front End Developer</p>
                      <p class="text-muted font-size-sm">Kota Madiun, Jawa Timur, Indonesia</p>
